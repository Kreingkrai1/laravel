    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{asset('adminlte/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image i style="opacity: .8">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="http://192.168.3.247/stock/file/pos-ssup/html/index.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Update Promo Type to Database</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="./index2.html" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Survey Product Expire on Shop</p>
                                    </a>
                                </li>
                                <!-- <li class="nav-item">
